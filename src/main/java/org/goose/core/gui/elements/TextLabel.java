...
public class TextLabel extends Element{
    ...
    public static void DrawTextBoxRestricted(Rectangle rect, int fontSize, String text, TextLabel label, Color textColor) {
            ...
            if (state == MEASURE_STATE) {
                ...
                if (codepoint == '\n') {
                    ...
                    if ((codepoint != ' ') && (codepoint != '\t')) {
                        Renderer.renderer.text.DrawTextCodepoint(rText.GetFontDefault(), codepoint, new Vector2(rect.x + textOffsetX , rect.y + textOffsetY), fontSize, textColor);
                    }
                }
